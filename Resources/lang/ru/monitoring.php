...
return [
    ...
    'admin' => [
        ...
        'show_ping' => 'Показывать пинг',
        'show_ping_help' => 'Если выключено, пинг не измеряется при обновлении статусов, API пинга отключён, в виджетах и карточке сервера пинг скрыт (включая колонку пинга игроков в CS2).',
